export const draftLeaveWarning =
  "Leave this draft edit? Local text and the save retry key will be lost. An in-flight or unknown save may still have been applied by Core; leaving does not undo it.";
