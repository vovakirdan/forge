  ...
  return (
    <section aria-label="Diagnostics" className="space-y-3">
      ...
      <p className="text-xs text-muted-foreground">
        Availability and loaded counts do not establish success or acceptance. Diagnostic bodies are
        unavailable here; linked objects are not fetched automatically.
      </p>
