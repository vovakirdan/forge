...
Baseline локального запуска FRONTEND-001 проверен. Далее отдельно
нарезаются [UI0.1](../docs/epics/ui0-e1-domain-contracts.md) (domain contracts)
и оставшаяся часть [UI0.3](../docs/epics/ui0-e3-frontend-tooling.md) (checks/test
harness). [UI0.2](../docs/epics/ui0-e2-browser-api.md) ждёт обоих эпиков.
...
параллельную валидацию в той же копии. Документацию можно готовить отдельно,
