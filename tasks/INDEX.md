...
Gateway/session и live Core proof остаются отдельными Task; полные epic gates
сохраняются.
...
FRONTEND-002/003/004/005/006: install, browser/static/contract/presentation tests,
