...
async fn unauthorized_or_cross_origin_browser_never_connects_to_existing_core_socket() {
    ...
    for path in [
        ...
        "/api/projects/01988000-0000-7000-8000-000000000001/employees/01988000-0000-7000-8000-000000000002",
        "/api/projects/01988000-0000-7000-8000-000000000001/employees/01988000-0000-7000-8000-000000000002/runs?limit=20",
