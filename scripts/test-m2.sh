...
cargo test -p forge-testkit --test m2_provider_live --test m2_git_proposal \
    --test m2_file_snapshots --test m2_file_delivery --locked
...
FORGE_INTEGRATION=1 cargo test -p forge-testkit --locked \
    ...
    --test m2_git_proposal --test m2_file_snapshots --test m2_file_delivery --test m2_provider_profiles \
